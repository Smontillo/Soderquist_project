...
void deom::rem(cx_cube& dtotal, const cx_cube& total, const double t) {
...
void deom::rem (cx_cube& dtotal, const cx_cube& total, const double t, const mat& sdip, const cube& pdip, const cx_vec& bdip, const pulse& p) {
...
void deom::rem (cx_cube& dtotal, const cx_cube& total, const double t, const mat& sdip, const cube& pdip, const cx_vec& bdip, const pulse& p, const ivec& projection) {
