...
class deom: public syst, public bath, public hidx {
    ...
    public:
        ...
        void oprAct (cx_cube& d_ddos, const mat& sdip, const cube& pdip, const cx_vec& bdip, const cx_cube& ddos, const char lrc='l', const int xp=0);
        ...
        void rem (cx_cube& d_ddos, const cx_cube& ddos, const double t, const mat& sdip, const cube& pdip, const cx_vec& bdip, const pulse& p);

        void rem (cx_cube& d_ddos, const cx_cube& ddos, const double t, const mat& sdip, const cube& pdip, const cx_vec& bdip, const pulse& p, const ivec& projection);
        ...
        inline bool is_valid (const cx_mat& ddo) const {
            return any(abs(vectorise(ddo))>ferr);  // armadillo's grammar
        }
...
void resp1st (const double w_max, const int nt, const double dt,
              ...
              const mat& sdip, const cube& pdip, const cx_vec& bdip,
